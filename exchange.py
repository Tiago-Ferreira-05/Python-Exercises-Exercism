...
def get_value_of_bills(denomination, number_of_bills):
    ...
    value_of_bills = round(denomination * number_of_bills)
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    max_value_after_exchange = amount - get_leftover_of_bills(amount, denomination)

    return max_value_after_exchange
